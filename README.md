...
### Change Node Name via Web UI
This was an oversight when designing the GUI.  It will be fixed but isn't a priority at this stage.  You can change it via DMX Workshop if you must :)
### DMX Input
